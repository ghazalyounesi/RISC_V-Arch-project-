    ...
    switch (opcode) {
        ...
        case 0b0010011:
            ...
            switch (funct3) {
                ...
                case 0b001: // slli
                    mnemonic = "slli";
                    imm = (raw >> 20) & 0x1F; // shamt is only 5 bits, not sign-extended
                    break;
                case 0b101: // srli/srai
                    if ((raw >> 25) == 0b0100000) { mnemonic = "srai"; }
                    else { mnemonic = "srli"; }
                    imm = (raw >> 20) & 0x1F; // shamt is only 5 bits
                    break;
                    // Note: Your original cpu.cpp did not list slti/sltiu, but adding them for completeness.
        ...
        case 0b0000011:
            ...
            // I-type (jalr): opcode=1100111 (IJ)
        case 0b1100111:
            // cpu.cpp handles this by mnemonic, we just need to not misclassify it.
            // Setting type to I_load is a safe choice as it won't match the first `if` in do_execute.
            type = InstrType::I_load;
            mnemonic = "jalr";
